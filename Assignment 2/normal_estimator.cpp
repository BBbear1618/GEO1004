...
void NormalEstimator::apply(easy3d::PointCloud *cloud, unsigned int k)
{
    ...
    //-----------------------------------------------------------------
    std::cout << "computing point cloud normals...[not implemented yet]" << std::endl;
    ...
    for (auto v : cloud->vertices()) {
        ...
        // TODO: when you obtained the normal of 'v', don't forget to write it values in the corresponding vertex property.
